...
public class CommentApiController {
	...
	public ResponseEntity<?> commentSave(@Valid @RequestBody CommentDto commentDto,
		...
		//json형태이므로 @Requestbody 붙여줘야함
		//System.out.println(commentDto);
		
		Comment comment = commentService.댓글쓰기(commentDto.getContent(), commentDto.getImageId(), principalDetails.getUser().getId()); //content,imageId,userId 넣기
